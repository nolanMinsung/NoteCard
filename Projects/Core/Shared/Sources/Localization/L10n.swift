...
public enum L10n {
    ...
    public enum CategoryList {
        ...
        public static let createDuplicateNameConfirm = "categoryList.createDuplicateNameConfirm".localized()
        public static let createDuplicateNameConfirmMessage = "categoryList.createDuplicateNameConfirmMessage".localized()
        public static let createDuplicateNameProceed = "categoryList.createDuplicateNameProceed".localized()
        public static let renameDuplicateNameConfirm = "categoryList.renameDuplicateNameConfirm".localized()
        public static let renameDuplicateNameConfirmMessage = "categoryList.renameDuplicateNameConfirmMessage".localized()
        public static let renameDuplicateNameProceed = "categoryList.renameDuplicateNameProceed".localized()
