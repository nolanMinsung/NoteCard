...
////  NoteCard
////
////  Created by 김민성 on 2024/02/04.
////
//
//import UIKit
//
//class TotalListTableViewCell: UITableViewCell {
//
...
//        self.contentView.frame = self.contentView.frame.inset(by: UIEdgeInsets(top: 6,
//                                                                               left: SizeContainer.screenSize.width * 0.025,
//                                                                               bottom: 6,
//                                                                               right: SizeContainer.screenSize.width * 0.025))
//        
...
//            
//        } else {
//            let roundBezierPath = UIBezierPath(roundedRect: CGRect(x: 3, y: 3, width: self.bounds.width, height: self.bounds.height), cornerRadius: 20)
...
//        
////        let minimumHeightConstraint = self.contentView.heightAnchor.constraint(greaterThanOrEqualToConstant: 115)
////        minimumHeightConstraint.priority = UILayoutPriority(760)
////        minimumHeightConstraint.isActive = true
////        
////        let maximumHeightConstraint = self.contentView.heightAnchor.constraint(lessThanOrEqualToConstant: 190)
////        maximumHeightConstraint.priority = UILayoutPriority(760)
////        maximumHeightConstraint.isActive = true
//        
...
//        
////        self.memoTextView.textInputView.setContentCompressionResistancePriority(UILayoutPriority(752), for: NSLayoutConstraint.Axis.vertical)
...
//        
////        self.memoTextView.heightAnchor.constraint(greaterThanOrEqualToConstant: 40).isActive = true
////        self.memoTextView.heightAnchor.constraint(lessThanOrEqualToConstant: 90).isActive = true
//        
//        let textViewMinimumHeightConstraint = self.memoTextView.heightAnchor.constraint(greaterThanOrEqualToConstant: 18)
//        textViewMinimumHeightConstraint.priority = UILayoutPriority(753)
//        textViewMinimumHeightConstraint.isActive = true
//        
//        let textViewMaximumHeightConstraint = self.memoTextView.heightAnchor.constraint(lessThanOrEqualToConstant: 87)
//        textViewMaximumHeightConstraint.priority = UILayoutPriority(754)
//        textViewMaximumHeightConstraint.isActive = true
//        
//    }
//    
//    
...
//        }
//        self.memoEntityManager.toggleIsFavorite(in: memoEntity)
...
//
//
//extension TotalListTableViewCell: UICollectionViewDataSource {
//    
...
//}
//
//extension TotalListTableViewCell: UICollectionViewDelegate {
//    
//}
//
//
